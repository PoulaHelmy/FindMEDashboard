...
export class FindSimilarComponent implements OnInit {
  ...
  imageUrls: string[];
  queryFace: string =
    'https://psfaceapicourse.blob.core.windows.net/individuals/steve4.png';
