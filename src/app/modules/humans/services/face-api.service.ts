...
export class FaceApiService {
  private baseUrl = 'https://findme.cognitiveservices.azure.com/face/v1.0';
  ...
  deletePersonGroup(personGroupId) {
    return this.http.delete(
      `${this.baseUrl}/persongroups/${personGroupId}`,
      httpOptions
    );
  }
  ...
  trainPersonGroup(personGroupId) {
    return this.http.post<any[]>(
      `${this.baseUrl}/persongroups/${personGroupId}/train`,
      null,
      httpOptions
    );
  }
  ...
  getPersonGroupTrainingStatus(personGroupId) {
    return this.http.get<any>(
      `${this.baseUrl}/persongroups/${personGroupId}/training`,
      httpOptions
    );
  }
  ...
  getPersonsByGroup(personGroupId) {
    return this.http.get<any[]>(
      `${this.baseUrl}/persongroups/${personGroupId}/persons`,
      httpOptions
    );
  }
  ...
  getPerson(personGroupId, personId) {
    return this.http.get<any[]>(
      `${this.baseUrl}/persongroups/${personGroupId}/persons/${personId}`,
      httpOptions
    );
  }
  ...
  getPersonFace(personGroupId, personId, faceId) {
    return this.http.get(
      `${this.baseUrl}/persongroups/${personGroupId}/persons/${personId}/persistedfaces/${faceId}`,
      httpOptions
    );
  }
  ...
  addPersonFace(personGroupId, personId, url) {
    return this.http.post<any>(
      `${this.baseUrl}/persongroups/${personGroupId}/persons/${personId}/persistedfaces?userData=${url}`,
      { url: url },
      httpOptions
    );
  }
  ...
  createFaceList(faceListId) {
    return this.http.put(
      `${this.baseUrl}/facelists/${faceListId}`,
      { name: faceListId },
      httpOptions
    );
  }
  ...
  addFace(faceListId, url) {
    return this.http.post(
      `${this.baseUrl}/facelists/${faceListId}/persistedFaces`,
      { url: url },
      httpOptions
    );
  }
  ...
  detect(url) {
    return this.http.post<any[]>(
      `${this.baseUrl}/detect?returnFaceLandmarks=false&returnFaceAttributes=age,gender,smile,glasses,emotion,facialHair`,
      { url: url },
      httpOptions
    );
  }
